...
remote-proto:
	protoc \
		--go_out=. --go_opt="Minternal/remote/gen.proto=github.com/istforks/sqlc/internal/remote" --go_opt=module=github.com/istforks/sqlc \
        --go-grpc_out=. --go-grpc_opt="Minternal/remote/gen.proto=github.com/istforks/sqlc/internal/remote" --go-grpc_opt=module=github.com/istforks/sqlc \
